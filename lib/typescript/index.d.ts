...
export declare const Tabs: {
    ...
    FlatList: <T>(p: import("react-native").FlatListProps<T> & {
        ref?: ((instance: import("react-native-gesture-handler").FlatList<T> | null) => void) | import("react").RefObject<import("react-native-gesture-handler").FlatList<T>> | null | undefined;
    ...
    } & import("react").RefAttributes<import("react-native-gesture-handler").ScrollView>>;
};
