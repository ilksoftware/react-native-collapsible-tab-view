...
const Container = /*#__PURE__*/_react.default.memo( /*#__PURE__*/_react.default.forwardRef(({
  ...
  const [containerWidth, setContainerWidth] = _react.default.useState(windowWidth);
  ...
  }, [containerWidth]); // handle window resize
  ...
  }, [containerHeight, containerWidth]); // fade in the pager if the headerHeight is not defined
