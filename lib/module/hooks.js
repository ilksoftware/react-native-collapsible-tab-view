import { useMemo, Children, useState, useCallback, useContext, useEffect } from 'react'; // import { useWindowDimensions } from 'react-native'
...
export function useCollapsibleStyle() {
  const {
    ...
    containerHeight,
    tabBarWidth
  } = useTabsContext(); // const windowWidth = useWindowDimensions().width
